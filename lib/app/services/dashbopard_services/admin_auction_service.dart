...
class AdminAuctionService extends GetxService {
  ...
  Future<void> fetchProducts({
    ...
    try {
      ...
      if (response.statusCode != 200 &&
        ...
        throw Exception(
          'Failed to fetch auctions. Status: ${response.statusCode}',
        );
      }
  ...
  Future<void> loadMoreProducts() async {
    ...
    try {
      ...
      currentPage.value--;
      Logger().e('Error loading more auctions', error: e);
    }
  }
  ...
  Uri _buildUri() {
    ...
    // 2. Include product_type = auction (key difference from products service)
