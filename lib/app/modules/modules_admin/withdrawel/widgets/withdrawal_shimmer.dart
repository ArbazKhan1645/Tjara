...
import 'package:tjara/app/modules/modules_admin/withdrawel/widgets/withdrawal_theme.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                // Avatar shimmer
                const ShimmerWidget(width: 48, height: 48, isCircle: true),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Row(
            children: [
              const ShimmerWidget(width: 40, height: 40, isCircle: true),
              const SizedBox(width: WithdrawalTheme.spacingMd),
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
