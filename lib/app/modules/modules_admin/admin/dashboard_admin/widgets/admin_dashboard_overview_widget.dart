...
class AdminDashboardOverviewWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final AdminDashboardService orderService = Get.find<AdminDashboardService>();
    final OrdersDashboardController controller = Get.find<OrdersDashboardController>();
    ...
    return Column(
      ...
      children: [
        ...
        if (_isAdmin) _OrdersListSection(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: List.generate(
          orders.length,
          (index) => Padding(
            padding: const EdgeInsets.only(bottom: AdminDashboardTheme.spacingSm),
          ...
          children: [
            ...
            _ActionMenuItem(
              ...
              onTap: () {
                ...
                widget.controller.fetchOrderItems(widget.order.id.toString());
                Future.microtask(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isEnabled
                ...
                : AdminDashboardTheme.surfaceSecondary.withValues(alpha: 0.5),
            borderRadius: BorderRadius.circular(AdminDashboardTheme.radiusSm),
            border: Border.all(
              color: AdminDashboardTheme.border,
            ),
      ...
      child: InkWell(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: isSelected ? AdminDashboardTheme.shadowColored(AdminDashboardTheme.primary) : null,
          ),
          child: Center(
            child: Text(
              page.toString(),
