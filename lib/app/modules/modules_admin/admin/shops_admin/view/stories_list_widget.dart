...
import 'package:tjara/app/modules/modules_admin/admin/shops_admin/view/stories_card.dart';
...
class ShopsContextsList extends StatelessWidget {
  ...
  const ShopsContextsList({super.key, required this.adminProductsService});
