...
import 'package:tjara/app/modules/modules_admin/admin/admin_jobs/view/jobs_list_widget.dart';
import 'package:tjara/app/services/dashbopard_services/adminJobs_service.dart';

class JobsViewWidget extends StatelessWidget {
  final bool isAppBarExpanded;
  final AdminJobsService adminProductsService;
  const JobsViewWidget({
    super.key,
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    AdminJobsList(adminProductsService: adminProductsService),
                  ],
                ),
              ),
            ],
