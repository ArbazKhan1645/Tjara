...
import 'package:tjara/app/modules/modules_admin/admin/services_admin/view/services_card.dart';
import 'package:tjara/app/services/dashbopard_services/services_service.dart';

class ServicesContextsList extends StatelessWidget {
  final ServicesService adminProductsService;

  const ServicesContextsList({super.key, required this.adminProductsService});
  ...
  Widget _buildEmptyState() {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Icon(
            isSearching ? Icons.search_off : Icons.design_services_outlined,
            size: 64,
            color: Colors.grey[400],
          ),
          const SizedBox(height: 16),
          Text(
            isSearching ? 'No services found' : 'No services yet',
            style: TextStyle(
              fontSize: 18,
              fontWeight: FontWeight.w600,
      ...
      children: [
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                'Showing ${adminProductsService.filteredProducts.length} of ${adminProductsService.totalItems.value} services',
                style: TextStyle(
                  fontSize: 14,
        ...
        ListView.separated(
          ...
          itemBuilder: (context, index) {
            final service = adminProductsService.filteredProducts[index];
            return AnimatedContainer(
              ...
              child: ServiceItemCard(
                product: service,
                onedit: () {
                  Get.to(() => InsertServiceScreen(serviceData: service))?.then(
                    (v) {
            ...
            () => ElevatedButton(
              onPressed:
                  adminProductsService.isDeleting.value
                      ? null
                      : () async {
                        final success = await adminProductsService
