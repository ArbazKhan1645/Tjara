    ...
    return Column(
      ...
      children: [
        ...
        Obx(() {
          ...
          final displayName = AdminProductsService.getSortOrderDisplayName(
            currentSort,
          );
          return Material(
            color: Colors.transparent,
                        ...
                        for (final entry in sortCategories.entries) ...[
                          ...
                          ...entry.value.map((order) {
                            ...
                            return ListTile(
                              dense: true,
                              selected: isSelected,
                              selectedTileColor: AdminProductsTheme.primary
                                  .withValues(alpha: 0.08),
                              title: Text(
                                AdminProductsService.getSortOrderDisplayName(
                                  order,
                                ),
                                style: TextStyle(
                                  fontSize: 14,
