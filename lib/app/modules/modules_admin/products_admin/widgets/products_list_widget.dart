...
import 'package:tjara/app/modules/modules_admin/products_admin/widgets/order_item_widget.dart';
            ...
            _buildActionChip(
              ...
              onTap:
                  () => _showBulkConfirmation(
                    context: context,
                    title: 'Pin Sale',
                    message: 'Pin $selectedCount selected products to sale?',
            ...
            _buildActionChip(
              ...
              onTap:
                  () => _showBulkConfirmation(
                    context: context,
                    title: 'Make Private',
                    message: 'Make $selectedCount selected products private?',
            ...
            _buildActionChip(
              ...
              onTap:
                  () => _showBulkConfirmation(
                    context: context,
                    title: 'Make Public',
                    message: 'Make $selectedCount selected products public?',
