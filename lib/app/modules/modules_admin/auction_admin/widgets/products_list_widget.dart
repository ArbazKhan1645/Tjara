...
import 'package:tjara/app/modules/modules_admin/auction_admin/widgets/order_item_widget.dart';
            ...
            Row(
              ...
              children: [
                _buildPaginationButton(
                  ...
                  onPressed:
                      currentPage > 1 ? adminAuctionService.previousPage : null,
            ...
            _buildActionChip(
              ...
              onTap:
                  () => _showBulkConfirmation(
                    context: context,
                    title: 'Pin Sale',
                    message: 'Pin $selectedCount selected auctions to sale?',
            ...
            _buildActionChip(
              ...
              onTap:
                  () => _showBulkConfirmation(
                    context: context,
                    title: 'Make Private',
                    message: 'Make $selectedCount selected auctions private?',
            ...
            _buildActionChip(
              ...
              onTap:
                  () => _showBulkConfirmation(
                    context: context,
                    title: 'Make Public',
                    message: 'Make $selectedCount selected auctions public?',
