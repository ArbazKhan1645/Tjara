    ...
    return Column(
      ...
      children: [
        ...
        Obx(() {
          ...
          final displayName = AdminCarsService.getSortOrderDisplayName(
            currentSort,
          );
          return Material(
            color: Colors.transparent,
                        ...
                        for (final entry in sortCategories.entries) ...[
                          ...
                          ...entry.value.map((order) {
                            ...
                            return ListTile(
                              dense: true,
                              selected: isSelected,
                              selectedTileColor: CarsAdminTheme.accent
                                  .withValues(alpha: 0.08),
                              title: Text(
                                AdminCarsService.getSortOrderDisplayName(order),
                                style: TextStyle(
                                  fontSize: 14,
                                  fontWeight:
                                      isSelected
  ...
  Widget _buildAnalyticsDateRange() {
    return Obx(() {
      ...
      return Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('ANALYTICS DATE RANGE', style: CarsAdminTheme.labelMedium),
          const SizedBox(height: CarsAdminTheme.spacingSm),
          Row(
            children: [
              Expanded(
