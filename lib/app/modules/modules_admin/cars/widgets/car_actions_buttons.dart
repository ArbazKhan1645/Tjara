...
class CarActionButtons extends StatelessWidget {
    ...
    return Row(
      ...
      children: [
        ...
        _buildActionButton(
          ...
          color:
              isActive ? CarsAdminTheme.success : CarsAdminTheme.textTertiary,
          backgroundColor:
              isActive ? CarsAdminTheme.success.withValues(alpha: 0.1) : null,
        ),
        _buildActionButton(
          ...
          color:
              isFeatured ? CarsAdminTheme.primary : CarsAdminTheme.textTertiary,
          backgroundColor: isFeatured ? CarsAdminTheme.primaryLight : null,
        ),
        _buildActionButton(
          icon: Icons.local_offer_rounded,
          tooltip: isDeal ? 'Deal Product' : 'Not on Deal',
          onTap: () => _showDealDialog(context),
          color: isDeal ? CarsAdminTheme.error : CarsAdminTheme.textTertiary,
          backgroundColor: isDeal ? CarsAdminTheme.errorLight : null,
        ),
        _buildActionButton(
        ...
        _buildActionButton(
          ...
          color:
              isPrivate ? const Color(0xFF6366F1) : CarsAdminTheme.textTertiary,
        ...
        _buildActionButton(
          ...
          color: isSold ? const Color(0xFFD97706) : CarsAdminTheme.textTertiary,
  ...
  void _showActiveDialog(BuildContext context) {
    _showConfirmationDialog(
      ...
      confirmColor: isActive ? CarsAdminTheme.warning : CarsAdminTheme.success,
  ...
  void _showSoldDialog(BuildContext context) {
    _showConfirmationDialog(
      context: context,
      title: 'Sold Status',
      message: isSold ? 'Mark as unsold?' : 'Mark as sold?',
