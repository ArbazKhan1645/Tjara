    ...
    return Column(
      ...
      children: [
        ...
        _UploadButton(
          ...
          onTap:
              () => controller.pickImage(ImageSource.gallery, isGallery: true),
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                Icon(icon, color: AuctionAdminTheme.accent, size: 20),
          ...
          child: Column(
            children: [
              Container(
                ...
                child: Icon(icon, size: 32, color: AuctionAdminTheme.accent),
              ),
              const SizedBox(height: AuctionAdminTheme.spacingMd),
              Text(
                label,
