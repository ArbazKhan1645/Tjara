...
class _ShippingHeader extends StatelessWidget {
  ...
  const _ShippingHeader({required this.isExpanded, required this.onToggle});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        const FieldLabel(
          label: 'Shipping Time',
          description: 'Enter the estimated delivery time range for this item.',
        ),
        Row(
          children: [
            // From field
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('From', style: AuctionAdminTheme.labelMedium),
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('To', style: AuctionAdminTheme.labelMedium),
                  const SizedBox(height: AuctionAdminTheme.spacingXs),
                  Obx(
                    () => TextFormField(
            ...
            Expanded(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('Unit', style: AuctionAdminTheme.labelMedium),
                  const SizedBox(height: AuctionAdminTheme.spacingXs),
                  Obx(
                    () => Container(
                      padding: const EdgeInsets.symmetric(
