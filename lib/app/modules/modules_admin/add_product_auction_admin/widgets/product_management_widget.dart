  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color:
              isActive ? AuctionAdminTheme.success : AuctionAdminTheme.border,
        ),
      ),
      child: Row(
        children: [
          ...
          return Column(
            children: [
              ...
              _TimePickerField(
                ...
                displayValue:
                    endTime != null ? controller.formatDateTime(endTime) : null,
      ...
      children: [
        ...
        const Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Auction Timing', style: AuctionAdminTheme.headingSmall),
              SizedBox(height: 2),
              Text(
              ...
              child: Row(
                children: [
                  ...
                  Icon(
                    ...
                    size: 18,
                    color:
                        hasValue ? accentColor : AuctionAdminTheme.textTertiary,
                  ),
                ],
              ),
            ),
