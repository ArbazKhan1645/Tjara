...
import 'package:tjara/app/modules/admin_products_config_module/admin_flash_deals/service/flash_deal_api_service.dart';
...
class FlashDealController extends GetxController {
  ...
  bool get _isLocalChangePending {
    ...
    return DateTime.now().difference(_lastLocalProductChange!) <
        _localChangeCooldown;
  }
