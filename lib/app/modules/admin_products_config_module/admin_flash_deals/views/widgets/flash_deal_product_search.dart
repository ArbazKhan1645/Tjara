                  ...
                  return Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        ...
                        items:
                            controller.templates.map((Template t) {
              ...
              Obx(
                () => SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    onPressed:
                        controller.isRestoringTemplate.value ||
                                controller.selectedTemplateId.value == null
                            ? null
                            : () => controller.restoreTemplate(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      disabledBackgroundColor: AdminTheme.primaryColor
              ...
              child: Row(
                ...
                children: [
                  Icon(
                    ...
                    size: 16,
                    color:
                        _showFilters ? Colors.white : AdminTheme.textSecondary,
                  ),
                  ...
                  if (_hasActiveFilters()) ...[
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color:
                            _showFilters ? Colors.white : AdminTheme.errorColor,
        ...
        child: Row(
          children: [
            Icon(
              ...
              size: 14,
              color:
                  date != null ? AdminTheme.primaryColor : AdminTheme.textMuted,
            ),
            const SizedBox(width: 8),
            Expanded(
              child: Text(
