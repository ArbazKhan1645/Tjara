...
import 'package:tjara/app/modules/admin/products_admin/controllers/ut.dart';
...
class AdminProductsController extends GetxController with ErrorHandlingMixin {
  ...
  Future<void> _initializeService() async {
    try {
      ...
      loadingManager.stopLoading();
      handleError(error, context: 'Service Initialization', stackTrace: stackTrace);
    }
  }
  ...
  Future<void> onSearch(String query) async {
    try {
      ...
      PerformanceTracker.endTracking('products_search',metadata:  {
                  ...
                  children: [
                    ...
                    _buildFilterSection(
                      ...
                      child: Obx(() => Wrap(
                        ...
                        children: ProductStatus.values.map((status) {
                          final isSelected = service.selectedStatus.value == status;
                          return FilterChip(
                    ...
                    _buildFilterSection(
                      ...
                      child: Obx(() => Wrap(
                        spacing: 8,
                        runSpacing: 8,
                        children: service.getPredefinedFilters().map((filter) {
                          final isActive = service.activeFilters
                    ...
                    _buildFilterSection(
                      ...
                      child: Obx(() => Column(
                        children: [
                          ...
                          if (service.startDate.value != null || service.endDate.value != null)
                            Padding(
                              padding: const EdgeInsets.only(top: 8),
                              child: TextButton.icon(
                                onPressed: () => service.updateDateRange(null, null),
...
void showProductFiltersDialog(AdminProductsService service) {
  Get.dialog(
    ProductFiltersDialog(service: service),
