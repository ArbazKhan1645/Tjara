...
import 'package:tjara/app/modules/admin/users/view/users_stastics.dart';
import 'package:tjara/app/modules/admin/users/view/users_widget.dart';
          ...
          children: [
            Expanded(
              child: GradientButtonWithLeftArrowAndText(
                ...
                onPressed: () {
                  Get.to(() => const InsertNewUser(), preventDuplicates: false)?.then(
                    (c) {
