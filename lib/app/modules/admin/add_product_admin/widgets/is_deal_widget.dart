    ...
    return ProductFieldsCardCustomWidget(
      column: Container(
        ...
        child: Column(
          ...
          children: [
            const Text("Is Deal", style: TextStyle(color: AppColors.adminGreyColorText, fontWeight: FontWeight.w500)),
            const SizedBox(height: 5),
            const Text("Select the is Deal", style: TextStyle(color: AppColors.adminGreyColorText)),
