...
import 'package:tjara/app/modules/modules_customer/tjara_jobs/api_service/jobs_aoi_service.dart';
  ...
  Future<void> submitApplication(String jobId) async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        debugPrint(
          'Submit application failed. Status: ${response.statusCode}, Body: $responseBody',
        );
