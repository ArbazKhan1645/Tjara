...
import 'package:tjara/app/modules/home/widgets/pro_det.dart';
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 12),
                  Container(width: 1, height: 24, color: const Color(0xFFDADADA)),
                  const SizedBox(width: 12),
                  Expanded(
                    child: TextField(
            ...
            Flexible(
              child: ListView.separated(
                ...
                separatorBuilder:
                    (_, __) => const Divider(height: 1, color: Color(0xFFF0F0F0)),
                itemBuilder: (context, index) {
